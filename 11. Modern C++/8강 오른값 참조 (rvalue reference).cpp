...
void TestKnight_ConstLValueRef(const Knight& knight) { /* const 붙은 함수만 호출 가능*/ }
...
int main()
{
	...
	std::unique_ptr<Knight> uptr2 = std::move(uptr); // move 사용 안하면 원래 사용 불가
