...
// public (공개?)	protected (보호받는?)	private (개인의?)
...
// - private : 개인적인 상속 -> 나까지만 잘 쓰고 자손들한테는 안 물려줄거야! (전부 -> private)
...
protected:
	...
	void ConnectCircuit() { } // 전기선을 연결시킨다
...
class TestSuperCar : public SuperCar // public 안 쓰면 private가 기본
{
public:
	void Test()
	{
